//POST: /api/v2/company/setting/basic-information
...
test.describe("/api/v2/company/setting/basic-information POST requests @company", async () => {
    test("POST with valid credentials @happy", async ({ request }) => {
        // POST the basic description
        const response = await request.post(`/api/v2/company/setting/basic-information`, {
