//POST: /api/v2/company/setting/apply-setting
...
test.describe("/api/v2/company/setting/apply-setting POST requests @company", async () => {
    test("POST with valid credentials @happy", async ({ request }) => {
        const response = await request.post(`/api/v2/company/setting/apply-setting`, {
