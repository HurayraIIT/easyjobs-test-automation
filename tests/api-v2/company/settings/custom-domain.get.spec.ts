//GET: /api/v2/company/setting/custom-domain
...
test.describe("/api/v2/company/setting/custom-domain GET requests @company", async () => {
    test("GET with valid credentials @happy", async ({ request }) => {
        const response = await request.get(`/api/v2/company/setting/custom-domain`, {
